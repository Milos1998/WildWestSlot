...
export class SlotMachine extends Container{
    ...
    constructor(){
        ...
        this.linesSelector= new Display(LEFT_PANNEL_X, LINES_SELECTOR_Y, DISPLAYS_WIDTH, DISPLAYS_HEIGHT, dataController.getMaxNumberOfLines().toString(), "Lines", true)
        this.linesSelector.lessButton.addListener("pointertap", e => gameController.decreaseNumberOfLines())
        this.linesSelector.enableLessButton()
        this.linesSelector.moreButton.addListener("pointertap", e => gameController.increaseNumberOfLines())
        this.linesSelector.disableMoreButton()

        this.betSelector= new Display(LEFT_PANNEL_X, BET_SELECTOR_Y, DISPLAYS_WIDTH, DISPLAYS_HEIGHT, dataController.getBet().toString(), "Bet per line", true)
        this.betSelector.lessButton.addListener("pointertap", e => gameController.decreaseBet())
        this.betSelector.enableLessButton()
        this.betSelector.moreButton.addListener("pointertap", e => gameController.increaseBet())
        this.betSelector.enableMoreButton()

        this.totalBetDisplay= new Display(LEFT_PANNEL_X, TOTAL_BET_DISPLAY_Y, DISPLAYS_WIDTH, DISPLAYS_HEIGHT, dataController.getTotalBet().toString() , "Total bet")
        ...
        this.balance= new Display(RIGHT_PANNEL_X, BALANCE_Y, DISPLAYS_WIDTH, DISPLAYS_HEIGHT, dataController.getBalance().toString(), "Balance")
