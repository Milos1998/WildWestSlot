...
export const REELS_HOLDER_WIDTH= REEL_WIDTH*REELS_PER_REEL_HOLDER + (REELS_PER_REEL_HOLDER+1)*REELS_HOLDER_FRAME_THICKNESS 
...
export const RIGHT_PANNEL_X= REELS_HOLDER_X + REELS_HOLDER_WIDTH + (APP_WIDTH - REELS_HOLDER_X - REELS_HOLDER_WIDTH - DISPLAYS_WIDTH)/2
...
export const CENTRAL_PANNEL_Y= REELS_HOLDER_Y + REELS_HOLDER_HEIGHT + (APP_HEIGHT - REELS_HOLDER_Y - REELS_HOLDER_HEIGHT  - BUTTONS_SIZE)/2
